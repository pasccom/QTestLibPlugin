...
class QTestLibModelTest : public QObject
{
    Q_OBJECT
...
void QTestLibModelTest::rowsAboutToBeInserted(const QModelIndex& index, int first, int last)
{
...
void QTestLibModelTest::rowsInserted(const QModelIndex& index, int first, int last)
{
    QVariantList argsList;
    argsList.append(index);
    argsList.append(first);
...
void QTestLibModelTest::rowsAboutToBeMoved(const QModelIndex& src, int first, int last, const QModelIndex& dst, int row)
{
    QVariantList argsList;
    argsList.append(src);
    argsList.append(first);
...
void QTestLibModelTest::rowsMoved(const QModelIndex& src, int first, int last, const QModelIndex& dst, int row)
{
    QVariantList argsList;
    argsList.append(src);
    argsList.append(first);
...
void QTestLibModelTest::dataChanged(const QModelIndex& topLeft, const QModelIndex& bottomRight)
{
    QVariantList argsList;
...
void QTestLibModelTest::addTestItem(void)
{
    ...
    SUB_TEST_FUNCTION(createSpies(&model, testSignals));
...
void QTestLibModelTest::loadResult(QDomDocument& dom, const QString& testName)
{
    BEGIN_SUB_TEST_FUNCTION
...
void QTestLibModelTest::createSpies(const QAbstractItemModel* model, const QDomElement& testSignals)
{
    BEGIN_SUB_TEST_FUNCTION
...
void QTestLibModelTest::createSpy(const QAbstractItemModel* model, const QString& signal)
{
    BEGIN_SUB_TEST_FUNCTION
...
void QTestLibModelTest::checkSignals(const QAbstractItemModel* model, const QDomElement& testSignals, const QString& testName)
{
    BEGIN_SUB_TEST_FUNCTION
...
void QTestLibModelTest::checkSignal(const QAbstractItemModel* model, const QVariantList& argList, const QDomElement& testSignal, const QDomElement& testResult)
{
    BEGIN_SUB_TEST_FUNCTION
...
QTEST_APPLESS_MAIN(QTestLibModelTest)

#include "qtestlibmodeltest.moc"
