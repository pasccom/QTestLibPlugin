...
XUnitXMLQTestLibParser::XUnitXMLQTestLibParser(QObject *parent) :
    AbstractTestParser(parent), mModel(NULL), mParserActive(false)
{
   mReader = new QXmlStreamReader();
}

TestModelFactory::ParseResult XUnitXMLQTestLibParser::parseStdoutLine(ProjectExplorer::RunControl* runControl, const QString& line)
{
...
TestModelFactory::ParseResult XUnitXMLQTestLibParser::parseStderrLine(ProjectExplorer::RunControl* runControl, const QString& line)
{
    Q_UNUSED(runControl);
    Q_UNUSED(line);
