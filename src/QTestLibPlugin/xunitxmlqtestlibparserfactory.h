...
template<class B>
AbstractTestParser* XUnitXMLQTestLibParserFactory<B>::getParserInstance(ProjectExplorer::RunControl *runControl) const
{
    ...
    return new XUnitXMLQTestLibParser(runControl);
}
