...
#ifndef FORCEXMLQTESTLIBPARSERTEST_H
#define FORCEXMLQTESTLIBPARSERTEST_H
...
class ForceXMLQTestLibParserFactoryTest : public QObject
{
    Q_OBJECT
public:
    inline ForceXMLQTestLibParserFactoryTest(void) {}
private Q_SLOTS:
...
#endif // FORCEXMLQTESTLIBPARSERTEST_H
