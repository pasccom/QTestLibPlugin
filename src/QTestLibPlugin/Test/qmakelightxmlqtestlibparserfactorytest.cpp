...
#include "qmakelightxmlqtestlibparserfactorytest.h"
...
void QMakeLightXMLQTestLibParserFactoryTest::initTestCase(void)
{
...
void QMakeLightXMLQTestLibParserFactoryTest::init(void)
{
    mProject = NULL;
}
...
void QMakeLightXMLQTestLibParserFactoryTest::dataTest(void)
{
...
void QMakeLightXMLQTestLibParserFactoryTest::dataMakeCheck(void)
{
...
void QMakeLightXMLQTestLibParserFactoryTest::testOneClass(void)
{
...
void QMakeLightXMLQTestLibParserFactoryTest::testAllMessages(void)
{
    QFETCH(QString, qtVersion);
    QFETCH(QStringList, cmdArgs);
    QFETCH(bool, result);
...
void QMakeLightXMLQTestLibParserFactoryTest::testMultipleClasses(void)
{
    QFETCH(QString, qtVersion);
    QFETCH(QStringList, cmdArgs);
    QFETCH(bool, result);
...
void QMakeLightXMLQTestLibParserFactoryTest::testSignalsTest(void)
{
    QFETCH(QString, qtVersion);
    QFETCH(QStringList, cmdArgs);
    QFETCH(bool, result);
...
void QMakeLightXMLQTestLibParserFactoryTest::testLimits(void)
{
    QFETCH(QString, qtVersion);
    QFETCH(QStringList, cmdArgs);
    QFETCH(bool, result);
...
void QMakeLightXMLQTestLibParserFactoryTest::testOneSubTest(void)
{
    QFETCH(QString, qtVersion);
...
void QMakeLightXMLQTestLibParserFactoryTest::testTwoSubTests(void)
{
    QFETCH(QString, qtVersion);
    QFETCH(Internal::QTestLibArgsParser::TestOutputFormat, format);
    QFETCH(Internal::QTestLibArgsParser::TestVerbosity, verbosity);
...
void QMakeLightXMLQTestLibParserFactoryTest::runTest(const QString& qtVersion, const QString& testName, const QStringList& cmdArgs, bool result)
{
...
void QMakeLightXMLQTestLibParserFactoryTest::runMakeCheck(const QString& qtVersion, const QString& testName, Internal::QTestLibArgsParser::TestOutputFormat format, Internal::QTestLibArgsParser::TestVerbosity verbosity, bool result)
{
    QVERIFY(openQMakeProject(Utils::FilePath::fromString(TESTS_DIR "/" + qtVersion + "/" + testName + "/" + testName + ".pro"), &mProject));
...
void QMakeLightXMLQTestLibParserFactoryTest::testFactory(ProjectExplorer::RunControl* testRunControl, bool result)
{
    // Retrieve factory:
    QLinkedList<QTestLibPlugin::Internal::AbstractTestParserFactory*> parserFactories = QTestLibPlugin::Internal::TestModelFactory::parserFactories(Utils::Id(QTestLibPlugin::Constants::LightXmlQTestLibParserFactoryId).withSuffix(QTestLibPlugin::Constants::BaseQMakeQTestLibParserFactoryId));
