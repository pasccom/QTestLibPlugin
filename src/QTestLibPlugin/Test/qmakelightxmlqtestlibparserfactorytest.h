...
#ifndef QMAKELIGHTXMLQTESTLIBPARSERTEST_H
#define QMAKELIGHTXMLQTESTLIBPARSERTEST_H
...
class QMakeLightXMLQTestLibParserFactoryTest : public QObject
{
    Q_OBJECT
public:
    inline QMakeLightXMLQTestLibParserFactoryTest(void) {}
private Q_SLOTS:
...
#endif // QMAKELIGHTXMLQTESTLIBPARSERTEST_H
