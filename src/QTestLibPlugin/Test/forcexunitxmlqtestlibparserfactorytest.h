...
#ifndef FORCEXUNITXMLQTESTLIBPARSERTEST_H
#define FORCEXUNITXMLQTESTLIBPARSERTEST_H
...
class ForceXUnitXMLQTestLibParserFactoryTest : public QObject
{
    Q_OBJECT
public:
...
#endif // FORCEXUNITXMLQTESTLIBPARSERTEST_H
