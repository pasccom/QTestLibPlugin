...
#ifndef FORCEPLAINTEXTQTESTLIBPARSERTEST_H
#define FORCEPLAINTEXTQTESTLIBPARSERTEST_H
...
class ForcePlainTextQTestLibParserFactoryTest : public QObject
{
    Q_OBJECT
public:
    inline ForcePlainTextQTestLibParserFactoryTest(void) {}
private Q_SLOTS:
...
private:
    ...
    void runTest(const QString& qtVersion, const QString& testName, const QStringList &cmdArgs);
    void runMakeCheck(const QString& qtVersion, const QString& testName, Internal::QTestLibArgsParser::TestOutputFormat format, Internal::QTestLibArgsParser::TestVerbosity verbosity);
...
#endif // FORCEPLAINTEXTQTESTLIBPARSERTEST_H
